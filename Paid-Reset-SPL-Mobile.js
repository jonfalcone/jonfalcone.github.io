/* Clears local storage and puts the user into a paid mobile SPL session */
(function() {
    if (typeof(_WF) !== "undefined") {
        let utmSource = _WF.apis_config && _WF.apis_config.snippets_config["mobile_spl_source"] || _WF.SINGLEPAGELAYOUTSOURCES[0] || "ft";
