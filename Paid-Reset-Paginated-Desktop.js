/* Clears local storage and puts the user into a paid desktop paginated session */
(function() {
    if (typeof(_WF) !== "undefined") {
        let utmSource = _WF.apis_config && _WF.apis_config.snippets_config["desktop_paginated_source"] || "tb";
